...
const ProductPage: React.FC = () => {
    ...
    const ImageView = (props: { image: string | undefined; }) => {
        return (
            <img src={props.image} alt="image" className={styles.imageScroll}/>
        )
    }
        ...
        <div className={styles.container}>
            ...
            <div className={styles.mainBlock}>
                    ...
                    <div className={styles.imageScroll}>
                        ...
                        <div className={styles.buttonsBlock}>
                            <button className={styles.circle} onClick={handlePrevImage}>
                                <ArrowDownIcon color={"secondary"} width={30} height={30} className={styles.prevImage}/>
                            </button>
                            <button className={styles.circle} onClick={handleNextImage}>
                                <ArrowDownIcon color={"secondary"} width={30} height={30} className={styles.nextImage}/>
                            </button>
                        </div>
                    </div>
                    <div className={styles.productContent}>
                        <Text tag={"p"} color={"primary"} weight={"bold"} className={styles.infoContentTitle}>
                            {data?.title}
                        </Text>
                        <Text tag={"p"} color={"secondary"} weight={"normal"} view={"p-20"}
                ...
                <div className={styles.relatedItemsBlock}>
                    <Text tag={"p"} color={"primary"} weight={"bold"} className={styles.relatedContentTitle}>
                        Related Items
                    </Text>
